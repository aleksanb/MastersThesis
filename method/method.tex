...
They should shed some ligt on attributes of RBN reservoir Computing systems that might be relevant to the creation and instrumentation of matter reservoirs.
...
There are a number of ways to estimate the numer of attractors and their properties of a specific RBN.
