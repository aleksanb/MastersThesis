...
The general structure of a Reservoir Computing system with all possible bells and whistles is shown in figure \ref{fig:rc-schema}.
...
\todo{Her skal jeg skrive litt kort om RBNs som base for reservoirs}
...
\todo{That K=3 is better than 2 and 1, and the relation to coputational capability as measure}
\todo{I can shortly mention the evolved readout layers as well?}
