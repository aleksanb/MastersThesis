...
\begin{figure}
  ...
  \caption{An example homogeneous RBN with $N=3, K=2, P=0.5$.}
...
This self-written framework serves as the basis for the simulations and analysis performed in this thesis as well.
