...
a plethora of RBN RC systems with $N=100, K=\{2, 3\}$ were able to solve the Temporal Parity 3 task with an accuracy of at least 98\% (as shown in figure \ref{figure:results:temporal-parity-3}).
